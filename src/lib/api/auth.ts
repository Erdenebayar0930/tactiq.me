 ...
 */
/**
 * ⚠ `code` нь ЗОРИУД: клиент 404-ыг бусад алдаанаас ЯЛГАЖ, өөр UI
 * харуулах боломжтой байх ёстой. Жишээ нь админ курс устгахад түүнийг
 * идэвхтэй болгосон сурагч `/learn` дээр мухардмал алдаа харахын оронд
 * «Курс сонгох» төлөв рүү унана (`app/(app)/learn/page.tsx`).
 */
export const notFound = (message = "Олдсонгүй.") =>
  NextResponse.json({ error: message, code: "not-found" }, { status: 404 });
