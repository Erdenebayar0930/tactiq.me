...
export const promoCodes = pgTable(
  "promo_codes",
  {
    ...
    /**
     * НИЙТ ХЯЗГААР — кодыг хэдэн ӨӨР худалдан авагч ашиглаж болох вэ.
     * `null` = хязгааргүй. Дүүрмэгц код хүчингүй болно (`resolvePromo`).
     *
     * ⚠ Шатны `limit`-ээс ӨӨР: шат дүүрвэл үндсэн хувь руу шилждэг, харин
     * энэ хязгаар дүүрвэл код ОГТ ажиллахгүй (`drizzle/0058_promo_max_uses.sql`).
     */
