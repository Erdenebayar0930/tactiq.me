...
/**
 * ГАДААД КАРТЫН ҮНЭ (ам.доллар, ЦЕНТЭЭР).
 *
 * ⚠ ХАНШААР ТООЦОХГҮЙ, урьдчилан ТОГТООСОН үнэ. Гүйлгээний үед ханш
 * татвал (1) гадаад API-аас хамаарна, (2) ижил багц өдөр бүр өөр үнэтэй
 * болж, (3) ханш унасан үед алдагдалтай зарагдана. Дэлгүүрийн үнэ нь
 * тогтвортой байх ёстой.
 *
 * ⚠ ЦЕНТЭЭР: бутархай тоогоор мөнгө тоолох нь бөөрөнхийлөлтийн алдаа
 * үүсгэдэг — гүйлгээний үйлчилгээ бүр бүхэл тоо хүлээж авдаг.
 *
 * ⚠ Төгрөгийн үнээс БИЕ ДААСАН: төгрөгийн үнийг өөрчлөхөд энэ нь
 * автоматаар өөрчлөгдөхгүй. Хоёуланг нь ХАМТ шинэчлэхээ мартуузай.
 */
export const PLAN_USD_CENTS: Record<PlanId, number> = {
  monthly: 399,
  quarterly: 999,
  halfYear: 1799,
  yearly: 2999,
  // Зарагдахаа больсон ч төрлийн бүрэн байдлын төлөө.
  family: 4999,
};
