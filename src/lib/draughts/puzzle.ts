...
export function draughtsPuzzleGoalLabel(puzzle: ParsedDraughtsPuzzle): string {
  ...
  // Золиос гаргасан цуваа нь «тулгууртай» — сурагчид энэ нь ЧУХАЛ сануулга:
  // эхний нүүдэл дүрсээ өгч байгаа нь алдаа биш, санаа юм.
  return puzzle.opponentCaptures > 0 ? `${base} (тулгууртай)` : base;
}
