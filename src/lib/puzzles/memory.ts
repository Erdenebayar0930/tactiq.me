 ...
 * тэмдэглэгээ (`img:animal-lion` — `lib/tactiq/itemArt.ts`).
 *
 * ⚠ 8 байсныг 28 болгов: зургийн тэмдэглэгээ түүнээс урт — хамгийн урт
 * нь «img:animal-chinchilla» (21). Хязгаар нь хөзөр дээр УРТ ТЕКСТ
 * гарахыг хоригложгүйн тулд байсан бөгөөд зураг нь текст биш тул тэр
 * эрсдэл алга. Гэхдээ хязгаарыг БҮРЭН авахгүй: `prompt`-той андуурч урт
 * өгүүлбэр бичих нь хөзрийг уншигдахгүй болгоно.
 */
export const MEMORY_ITEM_MAX = 28;
