...
export function CoachTip({
  ...
  return (
    <div className="flex items-start gap-2.5">
      ...
      */}
      {/*
        ⚠ ДӨРВӨЛЖИН хайрцаг БИШ, өндрөөр хэмжинэ. Дүрийн зураг нь өндөр
        (179×305) тул `size-12` гэх мэт дөрвөлжин хүрээнд `object-contain`
        хийхэд өргөнөөрөө шахагдаж, бодит өндөр нь хагас болдог — дүр
        жижиг, бүдэг харагдана.

        ⚠ Жинхэнэ хэмжээг нь `width`/`height`-д өгнө: Next.js эндээс
        харьцааг тооцож байрыг урьдчилж нөөцлөнө (зураг ачаалахад агуулга
        үсрэхгүй).
      */}
      {coach.image ? (
        <Image
