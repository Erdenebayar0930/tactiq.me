/**
 * Даамын «Тулгууртай 2 нүүдлийн цохилт» сэдвийг үүсгэх CLI.
 *
 * Ажиллуулах:
 ...
 * эхний хичээл нь «Нэг нүүдлийн цохилт»-ыг дуусгаагүй сурагчид ч НЭЭЛТТЭЙ
 * байна — өөрөөр хэлбэл бие даан эхэлнэ.
 *
 * ТУЛГУУР гэж юу вэ: цохилтын өмнөх БЭЛТГЭХ нүүдэл — ихэвчлэн дүрсээ
 * зориуд өгч, өрсөлдөгчийг албадан идүүлж, идсэн дүрс нь цохилтын «гүүр»
...
const UNIT_TITLE = "Тулгууртай 2 нүүдлийн цохилт";
const SIZE = 10;
const TOTAL = 12;
...
/**
 * Санамсаргүй байрлал. Цагаан бэр 0-р мөрөнд, хар бэр 9-р мөрөнд
...
/**
 * Байрлалаас «тулгууртай 2 нүүдлийн цохилт» хайна.
 *
...
function generateCombos(): Combo[] {
  ...
  if (combos.length < TOTAL) {
    throw new Error(`Зөвхөн ${combos.length} цохилт олдлоо — үрээ эсвэл нөхцөлөө өөрчилнө үү.`);
  }
...
async function main() {
  ...
  console.log(
    `✓ ${combos.length} тулгууртай цохилт шалгалтад тэнцлээ ` +
    ...
    for (let index = 0; index < combos.length; index += PER_LESSON) {
      ...
      for (const combo of chunk) {
        await db.insert(exercises).values({
          ...
          prompt:
            "Цагаанаар тоглож байна. Тулгуур нүүдлээ хийж, хариуг нь албадаад цохи.",
          fen: combo.fen,
