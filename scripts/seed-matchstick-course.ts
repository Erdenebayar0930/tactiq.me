 ...
 *
 * ⚠ ЭНЭ СКРИПТ НЬ НЭГ ХИЧЭЭЛД НЭГ ДАСГАЛ үүсгэдэг. Санд байгаа бүтэц нь
 * ӨӨР: хөнгөн/дунд дасгалууд нэг хичээлд багцлагдсан
 * (`scripts/retune-lessons.ts`). Тиймээс энэ скриптийг ДАХИН
 * ажиллуулсны дараа `npm run retune:lessons -- --apply` -г мөн
 * ажиллуулж, бүтэц, оноог сэргээнэ. Эс тэгвэл таавар дахин 200 ганц
 * товшилттой хичээл болж задарна.
 *
